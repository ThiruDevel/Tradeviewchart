...
RequestProcessor.prototype._sendSymbolHistory = function (symbol, startDateTimestamp, endDateTimestamp, resolution, response) {
	...
	var address = "/public?command=returnChartData&currencyPair=BTC_ETH&start=1514764800&end=9999999999&period="+period;
	...
	httpGet("poloniex.com", address, function (result) {
		// console.log(result);
